...
public class CitationController : Draggable {
    ...
    [SerializeField] private String incorrectlyDeliveredText;
    [SerializeField] private String incorrectlyDestroyedText;
    [SerializeField] private Collider2D collider;
    [SerializeField] private Canvas canvas;

    private bool _entering = true;

    public void Init(bool packageWasDelivered) {
        ...
        body.text = packageWasDelivered ? incorrectlyDeliveredText : incorrectlyDestroyedText;
